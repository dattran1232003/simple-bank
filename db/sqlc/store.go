...
// TransferTx performs a money from one account to another account
// If creates a transfer record, add account to entries and update account's balance within a single database transaction
